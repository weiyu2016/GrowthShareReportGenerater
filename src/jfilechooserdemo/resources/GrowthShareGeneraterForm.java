...
public class GrowthShareGeneraterForm extends javax.swing.JFrame {
    ...
    private void sourceFileLoaderActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void usFileLoaderActionPerformed(java.awt.event.ActionEvent evt) {                                             
        int returnVal = fileChooser.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            File file = fileChooser.getSelectedFile();
            try {
    ...
    private void caFileLoaderActionPerformed(java.awt.event.ActionEvent evt) {                                             
        int returnVal = fileChooser.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            File file = fileChooser.getSelectedFile();
            try {
    ...
    private void reportGeneratorActionPerformed(java.awt.event.ActionEvent evt) {                                                
        int index;
